...
public class ConfigHandler {
    ...
    private static Map<String, Object> loadConfig()
        ...
        try {
            ...
            // print an error message and throw a FileNotFoundException
            System.out.println(
    ...
    // method to load the example configuration file
    // and return a map of its key-value pairs
    private static Map<String, Object> loadExample()
        ...
        try {
            ...
            // create a new instance of the SnakeYAML parser
            Yaml yaml = new Yaml();
            // load the key-value pairs from the example configuration file
            // into the map
            exampleConfig = yaml.load(inputStream);
        } catch (FileNotFoundException e) {
            // if the example configuration file is not found,
    ...
    // method to check the values in the configuration file
    // against the values in the example configuration file
    private static void check(
        ...
        for (Map.Entry<String, Object> configIteration : config.entrySet()) {
            // check if the key in the configuration map
            // exists in the example configuration map
            ...
            // check if the value of the key in the configuration map
            // is equal to the value of the key in the example configuration map
            if (configIteration.getValue().equals(
        ...
        for (Map.Entry<String, Object> exampleConfigIteration
                : exampleConfig.entrySet()) {
            // check if the key in the example configuration map
            // exists in the configuration map
    ...
    private static Config constructConfig(Map<String, Object> config) {
        ...
        return new Config(
                // set the httpServerPort value to the value of the
                // "httpServerPort" key in the map
                Integer.parseInt(config.get("httpServerPort").toString()),
                // set the discordClientId value to the value of the
                // "discordClientId" key in the map
                config.get("discordClientId").toString(),
                // set the discordClientSecret value to the value of the
                // "discordClientSecret" key in the map
                config.get("discordClientSecret").toString(),
                // set the discordAppRedirectUri value to the value of the
                // "discordAppRedirectUri" key in the map
                config.get("discordAppRedirectUri").toString(),
                // set the discordOAuthUrl value to the value of the
                // "discordOAuthUrl" key in the map
